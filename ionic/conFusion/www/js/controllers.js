...
.controller('MenuController', ['$scope', '$stateParams', 'menuFactory', 'baseURL', function($scope, $stateParams, menuFactory, baseURL) {
                                                                                     $scope.baseURL = baseURL;
                                                                                     $scope.tab = 1;
                                                                                     $scope.tabList = [{ index: 1, title : "The Menu"}, { index : 2, title : "Appetizers"} , { index: 3, title :"Mains"} , { index : 4, title : "Desserts" }];
                                                                                     $scope.filterText = '';
...
.controller('AboutController', ['$scope', 'corporateFactory', 'baseURL', 'conFusionHistory',
                                function($scope, corporateFactory, baseURL, conFusionHistory) {
